namespace Rapport.Support.WUI
{
    ...
    public partial class Companies : System.Web.UI.Page
    {
        ...
        protected JsonPagedArray<CompanyView> LoadGridData(int webApiPageIndex, int[] profileStateIds, String tin)
        {
            var webApiClient = WebApiClientHandler.Get();
            JsonPagedArray<CompanyView> jpArray =
                AsyncHelper.RunSync<JsonPagedArray<CompanyView>>
                (
                    () => webApiClient.GetCompaniesListAsync(webApiPageIndex, profileStateIds, tin)
                );
        ...
        protected void SemiRefreshGrid()
        {
            ...
            JsonPagedArray<CompanyView> jpArray = LoadGridData(webApiPageIndex, filterValues.profileStateIds, filterValues.tin);
            ...
            if (jpArray != null)
            {
                ...
                // конвертим 
                List<CompanyView> data = jpArray.Items.ToList();
