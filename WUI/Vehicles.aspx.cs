namespace Rapport.Support.WUI
{
    ...
    public partial class Vehicles : System.Web.UI.Page
    {
        ...
        protected JsonPagedArray<VehicleView> LoadGridData(int webApiPageIndex, int[] profileStateIds)
        {
            var webApiClient = WebApiClientHandler.Get();
            JsonPagedArray<VehicleView> jpArray =
                AsyncHelper.RunSync<JsonPagedArray<VehicleView>>
                (
                    () => webApiClient.GetVehiclesListAsync(webApiPageIndex, profileStateIds)
                );
        ...
        protected void SemiRefreshGrid()
        {
            ...
            JsonPagedArray<VehicleView> jpArray =
                LoadGridData(webApiPageIndex, filterValues.profileStateIds);
            ...
            if (jpArray != null)
            {
                ...
                // конвертим 
                List<VehicleView> data = jpArray.Items.ToList();
